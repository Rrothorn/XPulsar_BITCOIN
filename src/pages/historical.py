            ...
            dbc.Row([
                dbc.Col([
                    create_titled_card('Choose TimePeriod',
                                           html.Div([
                                               dbc.Button('2021', id='y2021', n_clicks=0, style={'margin-left': '0px'}),
                ...
                dbc.Col([
                    ...
                    create_titled_card('Quarterly Overview Growth of Capital', dash_table.DataTable(
                                                            ...
                                                            style_header= {'backgroundColor': '#4D0C19', 'color': 'white', 'fontWeight': 'bold'},
...
def update_page1(y2021, y2022, y2023, total):
